    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('req_format', models.CharField(choices=[('mp4', 'MPEG-4 Part 14'), ('avi', 'AVI'), ('mkv', 'Matroska'), ('3gp', 'MPEG-4 Part 12')], default='mp4', max_length=3, verbose_name='The format this video should be converted to.')),
